...
SUB_BAIRRO_TO_BAIRRO_MAP = {
    ...
    # 21. MONSENHOR ALFREDO SIMONETI
    "MONS ALFREDO SIMONETI": "MONSENHOR ALFREDO SIMONETI",
    "ALFREDO SIMONETI": "MONSENHOR ALFREDO SIMONETI",
    "AMERICO": "MONSENHOR ALFREDO SIMONETI",
    # 22. NOVA BETANIA
